...
Welcome to Xeriscape's Minecraft server, Telzenith Realms; A survival multiplayer (SMP) server offering a Vanilla+ experience for members of the community. This welcome guide section of the community knowledgebase will provide all the relevant information needed to get connected to and setup on the server.
