...
# Server Rules
These rules specifically govern gameplay and interactions on the Telzenith Minecraft Server, and all players are expected to uphold them while playing on the server. For the complete set of community-wide policies and guidelines that apply across the entire network, please refer to the Xeriscape Guidelines.

## Player Conduct
Respect the server and your fellow players. This includes treating others with courtesy, avoiding harassment, and refraining from any conduct that would create a hostile or unpleasant environment. Furthermore, players should not make a deliberate effort to damage the server's stability, infrastructure, or performance, nor should they intentionally hinder the legitimate gameplay experience of others.

## Redstone Machines
All Redstone machines, clocks, timers, and automated contraptions must be constructed with a dedicated switch or a means to return the machine to an inactive state when they are not actively running or required for use.
...
Accounts may not be used to artificially boost another account. Examples include:

- Artificially increasing mob spawns in loaded chunks 
- Having multiple server economy accounts for funds 
- Having multiple ender chest storages 
- Automating gameplay processes or mechanics 
- Avoid punishments and moderation actions 

Your primary account is the account in which you are primarily recognized by on the server. When a punishment is given to one account, all other accounts will be actioned upon as well.

## General Policies
Players are forbidden from engaging in any activity that would be deemed as a violation of Mojang's [Terms and Conditions](https://www.minecraft.net/en-us/terms) or the [Minecraft EULA](https://www.minecraft.net/en-us/eula).